...
public class CommonPageLocators {
    ...
    public static final String SUCCESS_TOAST = "//div[@data-key='success']//div[contains(@class,'toastContent')]//div[contains(@id,toastDescription)]//span";
    ...
    public static final String DETAILS_FIELD_BY_LABEL_CUSTOM_LAYOUT = "//div[contains(@class,'active')]//span[text()='%s']//parent::*//following-sibling::*//*[starts-with(local-name(), 'lightning') and @data-output-element-id] | //div[contains(@class,'active')]//span[text()='%s']//parent::*//following-sibling::*//*[@data-output-element-id]//a";
